...
import { Avatar, Card, useAppearance } from '@vkontakte/vkui';
    ...
    return (
        <Card className="w-full flex flex-col items-center pb-10">
            ...
            <div className="flex items-center flex-col w-[calc(100%-26px)] rounded-[15px] bg-[#363738]">
                ...
                <h2
                    className={`w-[calc(100%-40px)] text-center whitespace-nowrap mb-20 ${appearance === 'light' ? 'text-white' : 'text-black'}`}
